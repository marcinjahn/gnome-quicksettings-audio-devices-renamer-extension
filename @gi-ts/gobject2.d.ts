...
export function param_value_defaults(
  pspec: ParamSpec,
  value: Value | any
): boolean;
export function param_value_is_valid(
  pspec: ParamSpec,
  value: Value | any
): boolean;
export function param_value_set_default(
  pspec: ParamSpec,
  value: Value | any
): void;
export function param_value_validate(
  pspec: ParamSpec,
  value: Value | any
): boolean;
...
export function type_check_value_holds(
  value: Value | any,
  type: GType
): boolean;
...
export type ToggleNotify<A = Object> = (
  data: any | null,
  object: A,
  is_last_ref: boolean
) => void;
...
export type WeakNotify<A = Object> = (
  data: any | null,
  where_the_object_was: A
) => void;
...
export class Binding extends Object {
  ...
  constructor(
    properties?: Partial<Binding.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<Binding.ConstructorProperties>,
...
export class BindingGroup extends Object {
  ...
  constructor(
    properties?: Partial<BindingGroup.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<BindingGroup.ConstructorProperties>,
...
export class InitiallyUnowned extends Object {
  ...
  constructor(
    properties?: Partial<InitiallyUnowned.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<InitiallyUnowned.ConstructorProperties>,
...
export abstract class ParamSpec<A = unknown> {
  ...
  constructor(
    properties?: Partial<ParamSpec.ConstructorProperties<A>>,
    ...args: any[]
  );
  _init(
    properties?: Partial<ParamSpec.ConstructorProperties<A>>,
...
export class SignalGroup extends Object {
  ...
  constructor(
    properties?: Partial<SignalGroup.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<SignalGroup.ConstructorProperties>,
...
export abstract class TypeModule extends Object implements TypePlugin {
  ...
  constructor(
    properties?: Partial<TypeModule.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<TypeModule.ConstructorProperties>,
...
type IFaces<Interfaces extends { $gtype: GType<any> }[]> = {
  [key in keyof Interfaces]: Interfaces[key] extends { $gtype: GType<infer I> }
    ? I
    : never;
};
...
> = Properties<P, SnakeToCamel<Props> & SnakeToUnderscore<Props>> &
  UnionToIntersection<Interfaces[number]> &
  P;
...
type SnakeToCamel<T> = {
  [P in keyof T as P extends string ? SnakeToCamelCase<P> : P]: T[P];
};
